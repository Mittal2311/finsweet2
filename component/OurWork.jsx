  ...
  return (
    <>
            ...
            <AnimationOnScroll animateIn="animate__fadeInDown"> 
              ...
              <h4 className={ourstyle.our_heading}>Workhub office Webflow Webflow Design</h4>
                <p className={ourstyle.our_parg}>Euismod faucibus turpis eu gravida mi. Pellentesque et velit aliquam</p>
            ...
            <AnimationOnScroll animateIn="animate__fadeInUp"> 
              ...
              <AnimationOnScroll animateIn="animate__fadeInUp"> 
              <Image src="/images/card2.svg" className={ourstyle.card_imgs} />
