...
export const OurTeam = () => {
    ...
    return(
        ...
        <h2 className={teamstyle.TeamHeading}>Meet our team</h2>
            ...
            <Row>
            {teamData.map((item) => (
             <Col xl={3} lg={3} md={6} sm={6} xs={12} className={teamstyle.MainCards}>
                ...
                <Image src={item.teamlinkedin} className={teamstyle.Icons }/>
                </div>
               <div className={teamstyle.HeadingCont}>
               <h6 className={teamstyle.TeamContHeading}>{item.teamheading}</h6>
                <span className={teamstyle.TeamTitle }>{item.teamtitle}</span>
               </div>
                </div>
             </Col>
             ))}
